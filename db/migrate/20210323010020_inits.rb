class Inits < ActiveRecord::Migration[5.2]
  def up
    ...
    #Criterios
    PpCriteria.create(priorization_process_id: 1, name: "Time",description: "This is a criteria",field_id: 1, default_value: 5)
    PpCriteria.create(priorization_process_id: 1, name: "Benefit",description: "This is a criteria",field_id: 2, default_value: 50)
